    ...
    <main>
      ...
      <section className="hero">
        <div className="hero-text">
          ...
          <h1 className="hero-name">Hi, I'm<br /><em>Risa.</em></h1>
          ...
          <div className="hero-buttons">
            ...
            <a href="https://flowcv.com/resume/owrmrl2cp64w" className="btn-ghost" target="_blank" rel="noreferrer">Download CV</a>
          </div>
      ...
      <section className="section contact-section">
        ...
        <a href="mailto:marisasofiamartignon@gmail.com" className="btn-primary">
          marisasofiamartignon@gmail.com
        </a>
      </section>
